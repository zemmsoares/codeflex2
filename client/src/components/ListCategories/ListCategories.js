                ...
                <div className="relative w-full h-full rounded-lg bg-white border shadow">
                  <div className="p-4">
                    <div className="flex flex-row pb-4 ">
                      <span className="rounded-full h-24 w-24 flex-shrink-0 bg-gray-200 flex justify-center items-center font-bold text-4xl text-white">
                      ...
                      <div className="ml-4">
                        <span className="flex items-center  ">
                          ...
                          <p className=" bg-gray-200 h-6 text-sm rounded-lg px-2 flex items-center justify-center ml-2">
                            {category.finishedProblems} /{" "}
                            {category.totalProblems} solved
                          </p>
                        </span>
                        <p>
                    ...
                    <div className="flex justify-between">
                      {category.finishedProblems == category.totalProblems ? (
                        <div className=" flex items-center justify-center  text-green-300 ">
                          <div className="flex justify-center items-center bg-green-400 rounded px-4 py-1">
                            <svg
                      ...
                      >
                        <button
                          type="button"
                          class=" m-2 py-1.5 px-5 mr-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                        >
                          View Category
                        </button>
                      </Link>
