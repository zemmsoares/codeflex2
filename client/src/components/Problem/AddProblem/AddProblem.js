...
function AddProblem() {
    ...
    const [problemDescription, setProblemDescription] = useState(EditorState.createEmpty());
    const [problemConstraints, setProblemConstraints] = useState(EditorState.createEmpty());
    const [problemInputFormat, setProblemInputFormat] = useState(EditorState.createEmpty());
    const [problemOutputFormat, setProblemOutputFormat] = useState(EditorState.createEmpty());
    ...
    return (
        <div className="container add-problem">
            ...
            {splitUrl(location.pathname)[0] === 'manage' && splitUrl(location.pathname)[1] !== 'tournaments' ?
                <div>
                    {<div className="row info-section">
                        ...
                        <div className="col-sm-10 add-problem-textarea">
                            <select name="category" className="textbox-problem" placeholder="Category" onChange={handleSelectBoxChange}>
            ...
            <div className="row">
                <div className="col-sm-offset-2 col-sm-10 col-xs-12">
                    <input type="button" className="btn btn-codeflex" onClick={saveProblem} name="" id="save-problem" value="Save problem" />
                </div>
            </div>
