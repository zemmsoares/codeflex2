                                ...
                                <tr key={problem.id} className="border-b border-gray-200">
                                    ...
                                    <td className="py-1 pr-6 w-64">
                                        <div className=" flex justify-end">
                                            ...
                                            <Link to={location.pathname + '/' + textToLowerCaseNoSpaces(problem.name) + '/edit'}>
                                                <button type="button" class="mx-2 py-1.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                                    Edit
                                                </button>
                                            </Link>


                                            <button onClick={() => deleteProblem(problem)} type="button" class=" py-1.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                                Delete
                                            </button>
