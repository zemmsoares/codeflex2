...
function NavBar() {
    ...
    return (
        <nav className="h-full bg-white border border-t-0 border-b-0 border-l-0">
            {logged ?
                <div className='flex flex-col h-screen'>
                    <div className={` ${open ? "w-64" : "w-20"}   p-5 pt-8  relative`}>
                        <img src={leftArrowIcon} onClick={() => setOpen(!open)} xmlns="http://www.w3.org/2000/svg" className={`absolute cursor-pointer -right-3 top-9 w-7 bg-white
                            border-2 rounded-full  ${!open && "rotate-180"}`} />

                        <Link to={'/'} onClick={() => setSelected('')} className="flex gap-x-4 items-center p-1">
                        <img
                                src={codeflexLogoPng}
                                className={`h-7 cursor-pointer duration-500 ${open && "rotate-[360deg]"
                                    }`}
                            />
                            <h1
                        ...
                        <ul className="py-2">
                            <li>
                                <Link to="/compete"
                                    ...
                                    className={`flex rounded-md p-2 cursor-pointer text-base font-semibold items-center gap-x-4 text-gray-400 hover:text-black hover:bg-gray-50
                                    ${selected == 'tournaments' ? 'text-black' : ''}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        ...
                        <ul className="py-2">
                            <li>
                                <Link to="/leaderboard"
                                    ...
                                    className={`flex rounded-md p-2 cursor-pointer text-base font-semibold items-center gap-x-4 text-gray-400 hover:text-black hover:bg-gray-50
                                    ${selected == 'leaderboard' ? 'text-black' : ''}`}>
                                   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
